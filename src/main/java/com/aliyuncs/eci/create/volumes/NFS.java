...
public class NFS {
    ...
    public static CreateContainerGroupResponse createContainerGroup() {
        ...
        volume.setType(VolumeType.NFSVolume.name());
        volume.setName("default-volume-nfs");
        volume.setNFSVolumePath("/");
        volume.setNFSVolumeServer("9cbb94a474-oav33.cn-beijing.nas.aliyuncs.com");
        volume.setNFSVolumeReadOnly(false);
        ...
        volumeMount.setName("default-volume-nfs");
